...
# TransposedLinear/replace_linear_with_transposed_ moved to
# PyTorchSimFrontend/transposed_linear.py (model-agnostic, also used by
# tests/GPT/test_GPT_NeoX_20B.py) -- kept importable under its old name here
# since sim_llama2_7B.py (and possibly others) import it from this module.
_replace_linear_with_transposed_ = replace_linear_with_transposed_
