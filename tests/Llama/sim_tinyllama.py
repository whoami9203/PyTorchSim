...
def _build_model_and_loader(model_id, dtype, device, num_layers):
    """Same meta-skeleton + streamed-checkpoint setup as test_tinyllama.py -- weights are still
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Simulate a TinyLlama-1.1B prefill or decode phase in isolation. Token ids and "
